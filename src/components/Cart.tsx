...
export default function Cart({ isOpen, onClose }: CartProps) {
  ...
  const handleRemoveItem = (itemId: string, selectedSize?: string, selectedColor?: string) => {
    removeFromCart(itemId, user?.uid, selectedSize, selectedColor);
  };

  const handleUpdateQuantity = (itemId: string, quantity: number, selectedSize?: string, selectedColor?: string) => {
    if (quantity < 1) return;
    updateCartItemQuantity(itemId, quantity, user?.uid, selectedSize, selectedColor);
  };
                      ...
                      <div className="flex items-center justify-between mt-4">
                        <div className="flex items-center border border-gray-200 rounded-lg bg-white">
                          <button
                            ...
                            className="p-2 hover:bg-gray-50 transition-colors rounded-l-lg disabled:opacity-50"
